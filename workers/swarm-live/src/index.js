...
<main class="wrap" id="missionShell">
  <header class="topbar">
    ...
    <div class="top-status"><span class="top-pill" id="runtimePill"><span class="dot"></span><span id="runtimeState" aria-live="polite">CHECKING RUNTIME</span></span><span class="top-pill"><span class="dot"></span>V4.46 PRODUCTION</span><span class="top-pill mono"><span class="dot"></span><span id="utcClock">--:--:-- UTC</span></span></div>
  </header>
