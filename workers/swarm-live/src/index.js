  ...
  async fetch(request, env, ctx) {
    ...
    if (request.method === 'GET' && url.pathname === '/api/swarm/health') {
      return json({
        ...
        protocol: PROTOCOL,
        version: env.SWARM_VERSION || '4.46.3',
