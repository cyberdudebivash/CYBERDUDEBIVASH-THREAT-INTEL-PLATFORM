#!/bin/bash
# ==============================================================================
# CYBERDUDEBIVASH(R) SENTINEL APEX v29.0  -  Installation Script
# ==============================================================================
...
echo -e "${BLUE}"
echo "+==================================================================+"
echo "|     CYBERDUDEBIVASH(R) SENTINEL APEX v29.0  -  APEX SCALE            |"
...
echo -e "${GREEN}[OK] agent/v29/ installed${NC}"
...
echo -e "${GREEN}[OK] Version updated to 29.0.0${NC}"
...
echo ""
echo -e "${GREEN}Platform Rating: 9.3/10 -> 10/10 [OK]${NC}"
