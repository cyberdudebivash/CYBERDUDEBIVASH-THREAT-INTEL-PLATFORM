...
Enhanced Manifest Engine: Robust Risk Extraction & TLP Sync.
"""
import os, json, re
...
class STIXExporter:
    ...
    def create_bundle(self, title, iocs, risk_score, enriched_data, mitre_data=None):
        """Standardized STIX generation for the Regex Parser."""
        ...
        for ioc_type, values in iocs.items():
            for val in values:
                objects.append({
                    ...
                    "description": f"Risk: {float(risk_score)}/10", # Format-aligned
