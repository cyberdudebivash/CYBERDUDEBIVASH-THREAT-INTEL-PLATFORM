...
class DetectionEngine:
    ...
    def _generate_windows_sigma_rule(self, title: str, iocs: Dict) -> str:
        ...
        if hashes or artifacts:
            ...
            # FIX: exclude 'condition' key — iterating .keys() previously included
            # 'condition' itself, producing invalid YAML like:
            #   'selection_hash or selection_file or condition'
            conditions = [k for k in rule['detection'].keys() if k != 'condition']
