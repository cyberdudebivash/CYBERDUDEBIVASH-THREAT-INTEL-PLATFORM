...
CYBERDUDEBIVASH(R) SENTINEL APEX v184.0 — Production JSON Sanitizer & Self-Healing Engine
============================================================================================
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="SENTINEL APEX — JSON Sanitizer & Self-Healing Engine v184.0"
    )
    ...
    print("=" * 72)
    print("SENTINEL APEX — JSON Sanitizer & Self-Healing Engine v184.0")
    print(f"Root   : {root}")
