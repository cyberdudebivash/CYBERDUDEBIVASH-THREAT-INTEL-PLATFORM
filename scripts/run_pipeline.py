...
TRUSTED_INTEL_SOURCES = {
    ...
    # v173.2: Platform-native sources — generated by SENTINEL-APEX pipeline itself.
    # Previously caused 300+ spurious "Unknown source" warnings per run.
    "SENTINEL-APEX", "Sentinel-APEX", "sentinel-apex",
    "CDB-APEX", "CDB", "CYBERDUDEBIVASH", "CDB-ENRICHER",
    "GitHub Security Advisories", "GitHub Security Advisory",
    "BleepingComputer", "SecurityAffairs", "TheHackerNews",
    "The Hacker News", "SecurityWeek", "DarkReading", "Dark Reading",
    "Malwarebytes", "Threat Intel", "Threat Intelligence",
    "Wired", "Ars Technica", "KrebsOnSecurity", "Krebs on Security",
    "Hackread", "Bleeping Computer", "InfoSecurity Magazine",
}
...
def stage_pipeline_consistency_check() -> None:
    ...
    try:
        ...
        for idx, item in enumerate(items):
            ...
            # v184.0 P0 INVARIANT: explicit CRITICAL gate.
            ...
            if _min_rank > _cur_rank:
                ...
                # v184.0: enforce priority and threat_level co-travel with severity
            ...
            # v184.0: final per-item invariant pass via SeverityInvariantInterceptor
            try:
...
def stage_sync_root_feed_json() -> None:
    ...
    # ── v184.0 P0: Severity Invariant Interceptor — authoritative final pass ─
    ...
    # ── End v184.0 Severity Invariant Interceptor ────────────────────────────
