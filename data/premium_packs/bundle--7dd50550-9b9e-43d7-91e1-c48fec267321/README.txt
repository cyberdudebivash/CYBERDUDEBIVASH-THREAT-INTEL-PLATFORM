...
THREAT  : CVE-2024-1524 - A local user can be impersonated when using federated authentication with Silent JIT Provisioning.
STIX ID : bundle--7dd50550-9b9e-43d7-91e1-c48fec267321
SCENARIO: MALWARE
RISK    : 4.9/10  |  SEVERITY: MEDIUM  |  TLP: TLP:GREEN
CVEs    : None identified
IOCs    : cve: 1
REPORT  : https://cyberbivash.blogspot.com/2026/02/cve-2024-1524-local-user-can-be.html
