...
THREAT  : CVE-2026-30830 - Defuddle: XSS via unescaped string interpolation in _findContentBySchemaText image tag
STIX ID : bundle--501f689a-e060-4468-ace4-0fe43c84acac
SCENARIO: XSS
RISK    : 5.2/10  |  SEVERITY: MEDIUM  |  TLP: TLP:GREEN
CVEs    : None identified
IOCs    : domain: 1 | cve: 1
REPORT  : https://blog.cyberdudebivash.com/2026/03/cve-2026-30830-defuddle-xss-via.html
