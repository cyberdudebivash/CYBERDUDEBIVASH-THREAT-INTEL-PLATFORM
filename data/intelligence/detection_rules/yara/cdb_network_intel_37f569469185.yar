rule CDB_SENTINEL_Network_Intel_37f569469185
{
    meta:
    ...
    strings:
        ...
        $ip_27 = "1.26.0.134" ascii wide nocase
        $ip_28 = "21.1.1.50" ascii wide nocase
        ...
        $dom_43 = "getsession.org" ascii wide nocase
        $dom_44 = "www.torproject.org" ascii wide nocase
        $dom_45 = "x.com" ascii wide nocase
        $dom_46 = "nuevaprodeciencia.club" ascii wide nocase
        $dom_47 = "odaracani.online" ascii wide nocase
        $dom_48 = "pastebin.com" ascii wide nocase
        $dom_49 = "vmi3003111.contaboserver.net" ascii wide nocase
        $dom_50 = "www.brighttalk.com" ascii wide nocase
        $dom_51 = "beeble.com" ascii wide nocase
        $dom_52 = "www.imperva.com" ascii wide nocase
        $dom_53 = "www.silobreaker.com" ascii wide nocase
        $dom_54 = "www.sonicwall.com" ascii wide nocase
        $dom_55 = "www.kaspersky.com" ascii wide nocase
        $dom_56 = "open.substack.com" ascii wide nocase
        $dom_57 = "otx.alienvault.com" ascii wide nocase
        $dom_58 = "cpuid.com" ascii wide nocase
        $dom_59 = "welcome.supp0v3.com" ascii wide nocase
        $dom_60 = "api.qpft5.com" ascii wide nocase
        $dom_61 = "leakix.net" ascii wide nocase
        $dom_62 = "module.info" ascii wide nocase
        $dom_63 = "security.snyk.io" ascii wide nocase
        $dom_64 = "www.carlsonsw.com" ascii wide nocase
        $dom_65 = "api.telegram.org" ascii wide nocase
        $dom_66 = "web.telegram.org" ascii wide nocase
        $dom_67 = "api.trongrid.io" ascii wide nocase
        $dom_68 = "rockwellautomation.com" ascii wide nocase
