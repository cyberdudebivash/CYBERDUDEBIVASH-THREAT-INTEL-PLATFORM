rule CDB_SENTINEL_Network_Intel_6dacf0fc2e91
{
    meta:
    ...
    strings:
        ...
        $ip_15 = "198.187.29.19" ascii wide nocase
        $ip_16 = "2.55.255.255" ascii wide nocase
        $ip_17 = "212.150.255.255" ascii wide nocase
        $ip_18 = "79.191.255.255" ascii wide nocase
        $ip_19 = "1.53.114.181" ascii wide nocase
        $ip_20 = "104.28.160.197" ascii wide nocase
        $ip_21 = "114.10.99.126" ascii wide nocase
        $ip_22 = "130.12.182.154" ascii wide nocase
        $ip_23 = "157.15.40.74" ascii wide nocase
        $ip_24 = "202.56.2.126" ascii wide nocase
        $ip_25 = "209.146.60.26" ascii wide nocase
        $ip_26 = "49.156.40.126" ascii wide nocase
        $ip_27 = "83.147.12.83" ascii wide nocase
        ...
        $dom_66 = "ecp.yusercontent.com" ascii wide nocase
        $dom_67 = "www.npmjs.com" ascii wide nocase
        $dom_68 = "ledger.com" ascii wide nocase
        $dom_69 = "vsccode-modetx.hf.space" ascii wide nocase
        $dom_70 = "blog.calif.io" ascii wide nocase
        $dom_71 = "blogs.oracle.com" ascii wide nocase
