rule CDB_SENTINEL_Hash_Intel_0274d3d7d571
{
    meta:
    ...
    strings:
        ...
        $h_2 = "58e17dd61d4d55fa77c7f2dd28dd51875b0ce900c1e43b368b349e65f27d6fdd" ascii nocase
        $h_3 = "8ee4ec425bc0d8db050d13bbff98f483fff020050d49f40c5055ca2b9f6b1c4d" ascii nocase
        $h_4 = "9c745f95a09b37bc0486bf0f92aad4a3d5548a939c086b93d6235d34648e683f" ascii nocase
        $h_5 = "a7eadcf81dd6fda0dd6affefaffcb33b1d8f64ddec6e5a1772d028ef2a7da0f2" ascii nocase
        $h_6 = "e1fc59c7ece6e9a7fb262fc8529e3c4905503a1ca44630f9724b2ccc518d0c06" ascii nocase
        $h_7 = "e512d22d2bd989f35ebaccb63615434870dc0642b0f60e6d4bda0bb89adee27a" ascii nocase
        ...
        $h_17 = "2b99ade9224add2ce86eb836dcf70040315f6dc95e772ea98f24a30cdf4fdb97" ascii nocase
        $h_18 = "61aca585687ec21a182342a40de3eaa12d3fc0d92577456cae0df37c3ed28e99" ascii nocase
        $h_19 = "ee07a74d12c0bb3594965b51d0e45b6f" ascii nocase
        $h_20 = "4AFDC05708B8B39C82E60ABE3ACE55DB" ascii nocase
        $h_21 = "C7610AE28655D6C1BCE88B5D09624FEF" ascii nocase
        $h_22 = "E05DF8EE759E2C955ACC8D8A47A08F42" ascii nocase
